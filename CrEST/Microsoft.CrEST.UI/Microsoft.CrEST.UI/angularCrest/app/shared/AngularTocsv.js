...
var AngularToCsv = (function () {
    function AngularToCsv(DataJSON, filename, options) {
        this.csv = "";
        var config = options || {};
     ...
     */
    AngularToCsv.prototype.generateCsv = function () {
     ...
     * Create Headers
     */
    AngularToCsv.prototype.getHeaders = function () {
     ...
     * Create Body
     */
    AngularToCsv.prototype.getBody = function () {
     ...
     * @param {any} data
     */
    AngularToCsv.prototype.formartData = function (data) {
     ...
     * @param {any} input
     */
    AngularToCsv.prototype.isFloat = function (input) {
        return +input === input && (!isFinite(input) || Boolean(input % 1));
    };
    return AngularToCsv;
}());
exports.AngularToCsv = AngularToCsv;
