(function (global, factory) {
	...
	(factory((global['ng2-inline-editor'] = global['ng2-inline-editor'] || {}),global._angular_core,global._angular_common,global._angular_forms));
...
InlineEditorComponent.decorators = [
    { type: _angular_core.Component, args: [{
                ...
                template: "<div>   <div id=\"inlineEditWrapper\">     <a [ngClass]=\"{'editable-empty': isEmpty }\" (click)=\"edit(value)\" [hidden]=\"editing && !disabled\">{{ showText() }}</a>     <div class=\"inlineEditForm form-inline\" [hidden]=\"!editing || disabled\">       <div class=\"form-group\">         <div #container></div>         <span class=\"inline-editor-button-group\">          <button id=\"inline-editor-button-save\" class=\"btn btn-xs btn-primary\"             (click)=\"onSubmit(value)\"><span class=\"fa fa-check\"></span></button>         <button class=\"btn btn-xs btn-danger\" (click)=\"cancel()\"><span class=\"fa fa-remove\"></span> </button>         </span>        </div>     </div>   </div> </div>",
                styles: ["a {   text-decoration: none;   color: #428bca;   border-bottom: dashed 1px #428bca;   cursor: pointer;   line-height: 2;   margin-right: 5px;   margin-left: 5px; }   /* editable-empty */  .editable-empty, .editable-empty:hover, .editable-empty:focus, a.editable-empty, a.editable-empty:hover, a.editable-empty:focus {   font-style: italic;   color: #DD1144;   text-decoration: none; }  .inlineEditForm {   display: inline-block;   white-space: nowrap;   margin: 0; }  #inlineEditWrapper {   display: inline-block; }  .inlineEditForm input, select {   width: auto;   display: inline; }  .inline-editor-button-group {   display: inline-block; }  .editInvalid {   color: #a94442;   margin-bottom: 0; }  .error {   border-color: #a94442; }  [hidden] {   display: none; }"],
                providers: [{
...
InlineEditorComponent.propDecorators = {
    ...
    'fnErrorLength': [{ type: _angular_core.Input },],
    'fnErrorPattern': [{ type: _angular_core.Input },],
...
exports.InputComponets = InputComponets;
